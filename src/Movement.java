/**
 * This file is responsible for dictating the movement in the game.
 */
/**
 * This class is responsible for dictating the movement in the game. This class
 * includes methods that help to allow a player to navigate the game map.
 *
 * @author Sarah Ramsey
 *
...
public class Movement {
  ...
  public static final String TOO_FAR_NORTH = "There is a cat as big as a house. "
      + "And it thinks you are a mouse! You need to sneak away from here";
  /** String printed if player moves too far East */
  public static final String TOO_FAR_EAST = "Careful! There is a cliff edge "
      + "here. You'll need to find another way";
  /** String printed if player moves too far South */
  public static final String TOO_FAR_SOUTH = "The path is blocked by a sleeping"
      + " giant. You cannot travel this way!";
  /** String printed if player moves too far West */
  public static final String TOO_FAR_WEST = "There's quicksand here. Turn "
      + "around before you sink!";
